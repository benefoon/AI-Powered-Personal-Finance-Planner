برای تطابق با ساختار جدیدی که کدهای شما به آن اضافه شده است، بخش‌های مربوط به **Data** و **Structures** را در README به‌روزرسانی کردم. نسخه به‌روزرسانی شده به این صورت خواهد بود:
